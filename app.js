...
`;
    ...
    setCurrent(id) {
        try {
            ...
            for (let view of this.#viewContainer.querySelectorAll(".border-view")) {
    ...
    removeTab(id) {
        ...
        this.#browserBody
            ...
            .removeChild(
                this.#viewContainer.querySelector('.border-view[data-id~="' + id + '"]')
            );
    }
    ...
    reloadTab() {
        ...
        this.#viewContainer.querySelector(".border-view.border-current").src =
            this.#handleURI(
                this.#browserBody
                    .querySelector("#border-tab-container")
    ...
    async #main() {
        ...
        this.#browserBody = document.createElement("div");
      	this.#browserBody.innerHTML=`<div id="border-root">
